    ...
    class NotificationHelper : INotification
    {
        ...
        public void CreateNotification(String title, String message)
        {
            try
            {
                ...
                var sound = global::Android.Net.Uri.Parse(ContentResolver.SchemeAndroidResource + "://" + mContext.PackageName + "/" + Resource.Drawable.notification_bg);
                ...
                mBuilder.SetSmallIcon(Resource.Drawable.iconBarrage);
                mBuilder.SetContentTitle(title)
                        ...
                        .SetSmallIcon(Resource.Drawable.iconBarrage)
