...
namespace AppBarragem.WEB.ADM
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            string ltecomponents = "~/Scripts/AppBarragem.WEB.ADM/components/";
            string lteplugins = "~/Scripts/AppBarragem.WEB.ADM/plugins/";
            string lte = "~/Scripts/AppBarragem.WEB.ADM/";
            ...
            bundles.Add(new ScriptBundle("~/bundles/lib")
                ...
                .Include(lte + "js/AppBarragem.WEB.ADM.min.js")
            ...
            bundles.Add(new ScriptBundle("~/bundles/mask")
                .Include(lte + "js/jquery.mask.js")
                .Include(lte + "js/jquery.mask.min.js"));
              ...
              bundles.Add(new StyleBundle("~/Content/css")
                ...
                .Include("~/Content/AppBarragem.WEB.ADM/css/AppBarragem.WEB.ADM.min.css")
                .Include("~/Content/AppBarragem.WEB.ADM/css/skins/_all-skins.min.css")
